...
Chương này diễn giải ý nghĩa của các kết quả Chương 4 (gồm benchmark Tier 1 §4.16) trong bối cảnh 20 công trình tham chiếu và 8 khoảng trống nghiên cứu (Gupta et al., 2024; Ren & Ji, 2019). Mục tiêu không phải tái liệt kê số liệu mà là trả lời **tại sao** pipeline dual-track hoạt động, **giới hạn nào** còn tồn tại, và **so sánh với ai** trên cơ sở metric và dataset tương đương.
